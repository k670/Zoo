...
class AnimalStorageTest {
    ...
    void beforEach() {
        ...
        String filePathXml = String.format("%s%s", System.getProperty("java.io.tmpdir"), "spring.xml");
        ApplicationContext applicationContext = new FileSystemXmlApplicationContext(filePathXml);


        this.animalStorage = applicationContext.getBean(AnimalStorage.class,this.filePath);//null?
        String jsonBody = "{\n" +
